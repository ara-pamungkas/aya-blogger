      ...
      <div className="flex items-center justify-between">
        ...
        <div className="">
          ...
          <p className="mt-8 text-md md:text-xl">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Recusandae, iure? Libero, beatae animi omnis alias atque voluptas autem doloribus, error doloremque, sit est possimus ex facere eius nisi corporis! Incidunt.
          </p>
        </div>
        {/* animated button */}
